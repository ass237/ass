...
const BloodRequestForm = () => {
  ...
  const onSubmit = handleSubmit(async (formData) => {
    try {
      ...
      // const hasUser = await checkUserSetRole(formData.email)
      ...
      //     await createBloodRequest(state,{
      //    ...formData,
      //     role: userRole
      //   })
      ...
      await createBloodRequest(state,{...formData,role:"GUEST"});
  ...
  return (
    ...
    <form
      ...
      onSubmit={onSubmit}
    >
      <h1 className="text-3xl font-semibold text-center text-gray-800 mb-6">Guest Request Blood  Form</h1>
